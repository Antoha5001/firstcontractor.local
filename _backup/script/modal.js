(function () {
	...
	window.addEventListener('DOMContentLoaded', function () {
			...
			this.button.addEventListener('click', function () {
				...
				request.onreadystatechange = function (e) {
					...
					if (request.readyState === 4) {
						...
						// modalBox.setContent("/agreement/index.php");
						...
						var modalForm = new Validator({
							id: "contacts-form",
							submit: "form-button",
							phpScript: "/local/templates/.default/assets/script/mailer_topbx.php"
		...
		var modal = new Modal({
			...
			included : "/local/templates/.default/includes/top_form2.php"
